...
class _AddRequestPageState extends State<AddRequestPage> {
  ...
  void initState(){
    super.initState();
    _requestListNameController = new TextEditingController(text: widget.request.requestName);
    _requestListDateController = new TextEditingController(text: widget.request.requestDate);
    _requestListDescController = new TextEditingController(text: widget.request.requestDesc);
  }
